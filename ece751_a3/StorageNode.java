...
public class StorageNode {
	...
	private void execute(String[] args) throws TTransportException, Exception {
		curClient = CuratorFrameworkFactory.builder().connectString(args[2]).retryPolicy(new RetryNTimes(10, 1000))
		...
		curClient.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL).forPath(args[3] + "/child",
